    ...
    # Tier 1: VA.gov sources
    {
        ...
        "resources": [
            ...
            },
            {
                ...
                "description": "SSVF provides case management and supportive services to prevent housing instability and promote housing stability among very low-income Veteran families.",
                "summary": "Housing assistance and case management for veteran housing stability.",
                "eligibility": "Very low-income Veteran families experiencing homelessness or at risk of housing instability.",
                ...
                "categories": ["housing"],
                "subcategories": ["housing_stability", "case_management"],
                "scope": ResourceScope.NATIONAL,
            ...
            },
            {
                ...
                "description": "HUD-VASH combines Housing Choice Voucher (Section 8) rental assistance with VA supportive services to help veterans experiencing homelessness and their families find and sustain permanent housing.",
                "summary": "Section 8 housing vouchers combined with VA case management for veterans experiencing homelessness.",
                "eligibility": "Veterans experiencing homelessness and their families. Veterans must be eligible for VA health care.",
