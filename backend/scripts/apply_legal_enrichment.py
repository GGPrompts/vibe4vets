#!/usr/bin/env python3
"""Apply Legal resources website enrichment to the database.

This script reads the legal_website_enrichment.json file and updates
resources in the database with the found URLs.

Usage:
    python scripts/apply_legal_enrichment.py          # Dry run - show what would be updated
    python scripts/apply_legal_enrichment.py --apply  # Apply updates to database
"""
...
def load_enrichment_data() -> list[dict]:
    ...
    data_path = Path(__file__).parent.parent / "data" / "legal_website_enrichment.json"
