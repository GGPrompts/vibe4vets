# SSVF Grantee Enrichment - Batch 1 (Grantees 1-78)

You are a coordinator enriching SSVF grantee data. Your job is to find contact information for 78 organizations.

## Your Batch

Read: `backend/data/ssvf/grantees-batch-1.json`
Save results to: `backend/data/ssvf/enriched-batch-1.json`
...
After each batch of 5, append results to `enriched-batch-1.json`:
...
1. Read `backend/data/ssvf/grantees-batch-1.json`
