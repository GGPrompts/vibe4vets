# SSVF Grantee Enrichment - Batch 3 (Grantees 157-235)

You are a coordinator enriching SSVF grantee data. Your job is to find contact information for 79 organizations.

## Your Batch

Read: `backend/data/ssvf/grantees-batch-3.json`
Save results to: `backend/data/ssvf/enriched-batch-3.json`
...
4. Repeat until all 79 are done
...
After each batch of 5, append results to `enriched-batch-3.json`:
...
1. Read `backend/data/ssvf/grantees-batch-3.json`
2. Process grantees 1-5 with 5 parallel Haiku agents
3. Save results
4. Continue with 6-10, 11-15, etc.
5. Keep going until all 79 are enriched
